...
tf.app.flags.DEFINE_string("file", "CNNAdTrain_GANWEIGHT0.010000_Sampling0.950000_samples.h5", "which file to load")
...
def main():
  ...
  for seed in np.arange(8):
      for action in actions:
          ...
          with h5py.File( '/home/lichen/data_process/allsamples/human3.6m/'+FLAGS.file, 'r' ) as h5f:
          ...
          path="/home/lichen/data_process/allsamples/human3.6m/samples/"+FLAGS.file+'gt_'+str(seed) +'/'+action
